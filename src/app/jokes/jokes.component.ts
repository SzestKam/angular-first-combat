...
import {ChuckNorisJoke} from '../model/ChuckNorisJoke';
...
export class JokesComponent implements OnInit {
  ...
  constructor(private jokeSrv: JokesService) {
    this.sample = {
      ...
      updated_at: '2020-01-05 14:43:23.240175',
  ...
  ngOnInit(): void {
    this.nextRandomJoke();
    this.jokeSrv.getCategories()
      .subscribe(categories => this.categories = categories);
  }

  nextRandomJoke() {
    this.jokeSrv.getRandomJoke()
      .subscribe(joke => this.sample = joke);
  }
